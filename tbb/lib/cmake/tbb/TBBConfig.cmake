...
foreach (_tbb_component ${TBB_FIND_COMPONENTS})
    ...
    get_filename_component(_tbb_release_lib "${CMAKE_CURRENT_LIST_DIR}/../../${_tbb_subdir}/lib${_tbb_component}${_bin_version}.so.${_${_tbb_component}_bin_version}" ABSOLUTE)

    if (NOT TBB_FIND_RELEASE_ONLY)
        get_filename_component(_tbb_debug_lib "${CMAKE_CURRENT_LIST_DIR}/../../${_tbb_subdir}/lib${_tbb_component}${_bin_version}_debug.so.${_${_tbb_component}_bin_version}" ABSOLUTE)
    endif()
